...
from tracerigor.server.serial import serialize_step_result, serialize_observation
import hydra
...
class BatchEnvServer:
    ...
    def _setup_routes(self):
        ...
        def reset_batch():
            ...
            # Serialize observations to ensure JSON-safe output (e.g. PIL Images -> base64)
            serialized = {
                env_id: (serialize_observation(obs), info)
        ...
        def step_batch():
            ...
            # Serialize step results to ensure JSON-safe output (e.g. PIL Images -> base64)
            serialized = {
                env_id: serialize_step_result(result)
