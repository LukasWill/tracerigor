...
from tracerigor.inference.model_interface.factory_model import ModelFactory
from tracerigor.rollout.inference_rollout.inference_rollout_service import InferenceRolloutService
from tracerigor.inference.utils.logging import log_results_to_wandb
...
def setup_wandb(model_name: str, wandb_path_name: str, model_config: Dict, inference_config: Dict) -> None:
    ...
    wandb.init(
        project=inference_config.get('wandb_project', 'tracerigor-inference'),
        name=run_name,
        config={
