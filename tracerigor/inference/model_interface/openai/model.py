# tracerigor/mllm_agent/model_interface/openai/model.py
import base64
import logging
import re
...
from tracerigor.inference.model_interface.base_model import BaseModelInterface
...
class OpenAIModelInterface(BaseModelInterface):
    ...
    def _process_image_for_openai(self, image: Any) -> str:
        ...
        if isinstance(image, Image.Image):
            ...
            from tracerigor.server.serial import deserialize_pil_image
