...
def handle_qwen_multimodal_data(
    ...
    # debug prints
    ###############################################################################
    # 'multi_modal_inputs': array([{'pixel_values': tensor([[ 0.7771,  0.7771,  0.7771,  ..., -1.4802, -1.4802, -1.4802],
    # [ 0.7771,  0.7771,  0.7771,  ..., -0.7408, -0.2146,  0.2546],
    # [ 0.7771,  0.7771,  0.7771,  ...,  0.7381,  0.7381,  0.7381],
    # ...,
    # [ 0.7771,  0.7771,  0.7771,  ..., -1.4802, -1.4802, -1.4802],
    # [ 0.7771,  0.7771,  0.7771,  ...,  0.0413, -0.4848, -0.9967],
    # [ 0.7771,  0.7771,  0.7771,  ..., -1.4802, -1.4802, -1.4802]]), 'image_grid_thw': tensor([[ 1, 36, 36],
    #                [ 1, 36, 36],
    #                [ 1, 36, 36],
    #                [ 1, 36, 36],
    #                [ 1, 36, 36]])},
