...
class QwenVLRolloutManager():
    ...
    def reset(self, mini_batch:DataProto):
        ...
        # [DEBUG] row_dict keys() are dict_keys(['data_source', 'prompt', 'extra_info'])
        # example row_dict is {'data_source': 'sokoban', 'prompt': array([{'content': '', 'role': 'user'}], dtype=object), 'extra_info': {'env_config': {'prompt_format': 'grounding_worldmodeling', 'render_mode': 'vision', 'use_state_reward': False}, 'env_name': 'sokoban', 'seed': 162, 'split': 'test'}} ## added 14.10.2025
