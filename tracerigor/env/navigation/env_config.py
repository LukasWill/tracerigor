...
class NavigationEnvConfig(BaseEnvConfig):
    ...
    # "free_think", "no_think", "grounding", "worldmodeling",
    # "grounding_worldmodeling", "reflact", "reflact_diverse"
    ...
    def config_id(self) -> str:
        ...
        id_fields = ["eval_set", "render_mode", "max_actions_per_step", "prompt_format"]
