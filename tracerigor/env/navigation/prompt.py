...
FORMAT_CONFIGS = {
    ...
    "reflact": {
        "description": "You should first reflect on the robot's current visual state, the target object, progress toward the human instruction, and any obstacles or corrections needed. Then output your action for this turn.",
        "format": "<reflection>...</reflection><action>...</action>",
        "example": """<reflection>I am in a living room. There is a couch to my left, a TV in front of me, and a doorway to the kitchen on my right. The target object, a vase, appears to be on a shelf near the kitchen doorway. I need to move toward the kitchen doorway to reach the vase, so I will move forward to get closer to the center of the room, then turn right and move toward the kitchen.</reflection><action>moveahead{action_sep}moveahead{action_sep}rotateright{action_sep}moveahead{action_sep}moveahead</action>"""
    },
    "reflact_diverse": {
        "description": "You should first reflect on the robot's current visual state, the target object, progress toward the human instruction, and any obstacles or corrections needed. Your reflection may ground the current view, monitor progress after prior actions, or revise the next move after feedback. Then output your action for this turn.",
        "format": "<reflection>...</reflection><action>...</action>",
        "examples": [
            """<reflection>I am in a living room. There is a couch to my left, a TV in front of me, and a doorway to the kitchen on my right. The target object, a vase, appears to be on a shelf near the kitchen doorway. I need to move toward the kitchen doorway to reach the vase, so I will move forward to get closer to the center of the room, then turn right and move toward the kitchen.</reflection><action>moveahead{action_sep}moveahead{action_sep}rotateright{action_sep}moveahead{action_sep}moveahead</action>""",
            """<reflection>I can see the kitchen doorway to my right, and I need to go there to find the refrigerator. I should turn right and move forward. After these actions, I expect to be in the kitchen doorway, with the kitchen counter and sink in front of me, the refrigerator against the wall to the left, and a kitchen island in the center of the room.</reflection><action>rotateright{action_sep}moveahead{action_sep}moveahead</action>""",
            """<reflection>I am at the entrance of a bedroom. There is a bed to the left, a desk with a lamp on the right, and a closet straight ahead. The target object, a book, appears to be on the desk. I need to move toward the desk to reach the book, so I will turn right and move forward. After these actions, I expect to be standing in front of the desk with the target book within reach on the right side of the desk.</reflection><action>rotateright{action_sep}moveahead{action_sep}moveahead</action>""",
        ],
        "example": """<reflection>I am in a living room. There is a couch to my left, a TV in front of me, and a doorway to the kitchen on my right. The target object, a vase, appears to be on a shelf near the kitchen doorway. I need to move toward the kitchen doorway to reach the vase, so I will move forward to get closer to the center of the room, then turn right and move toward the kitchen.</reflection><action>moveahead{action_sep}moveahead{action_sep}rotateright{action_sep}moveahead{action_sep}moveahead</action>"""
    }
}
...
Round 4:
Env_feedback: Success"""
    elif selected_format == "reflact":
        example=f"""Example:
Round 1:
image_1
<reflection>I am in a living room. There is a couch to my left, a TV in front of me, and a doorway to the kitchen on my right. The target object, a vase, appears to be on a shelf near the kitchen doorway. I need to move toward the kitchen doorway to reach the vase, so I will move forward to get closer to the center of the room, then turn right and move toward the kitchen.</reflection>
<action>moveahead, moveahead, rotateright, moveahead, moveahead</action>
Round 2:
Env_feedback: Success"""
    elif selected_format == "reflact_diverse":
        example=f"""Examples:
1.
image_2
<reflection>I am in a living room. There is a couch to my left, a TV in front of me, and a doorway to the kitchen on my right. The target object, a vase, appears to be on a shelf near the kitchen doorway. I need to move toward the kitchen doorway to reach the vase, so I will move forward to get closer to the center of the room, then turn right and move toward the kitchen.</reflection>
...
image_3
<reflection>I can see the kitchen doorway to my right, and I need to go there to find the refrigerator. I should turn right and move forward. After these actions, I expect to be in the kitchen doorway, with the kitchen counter and sink in front of me, the refrigerator against the wall to the left, and a kitchen island in the center of the room.</reflection>
<action>rotateright, moveahead, moveahead</action>
3.
image_4
<reflection>I am at the entrance of a bedroom. There is a bed to the left, a desk with a lamp on the right, and a closet straight ahead. The target object, a book, appears to be on the desk. I need to move toward the desk to reach the book, so I will turn right and move forward. After these actions, I expect to be standing in front of the desk with the target book within reach on the right side of the desk.</reflection>
<action>rotateright, moveahead, moveahead</action>"""
...
{config["format"]}"""
        ...
        if add_example:
            ...
            use_diverse_examples = kwargs.get("use_diverse_examples", format_type == "reflact_diverse")
            random_example = kwargs.get("random_example", False)

            if examples and use_diverse_examples:
                examples_text = "\n".join(
                    f"{i}. {example.format(action_sep=action_sep)}"
                    for i, example in enumerate(examples, 1)
                )
                return base_prompt + "\nExamples:\n" + examples_text
            if examples and random_example:
                import random
                example_text = random.choice(examples).format(action_sep=action_sep)
                return base_prompt + '\n' + f"e.g. {example_text}"
