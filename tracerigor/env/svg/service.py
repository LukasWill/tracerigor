...
from tracerigor.env.svg.env import SVGEnv
from tracerigor.env.svg.env_config import SvgEnvConfig
from tracerigor.server.serial import serialize_observation, serialize_step_result
from tracerigor.env.svg.score import calculate_total_score, calculate_total_score_batch
from tracerigor.env.svg.svg_utils import process_and_rasterize_svg, is_valid_svg
from tracerigor.env.utils.context_utils import parse_llm_raw_response, convert_numpy_to_PIL
from .service_config import SVGServiceConfig
from tracerigor.env.svg.svg_utils import (process_and_rasterize_svg, is_valid_svg, load_svg_dataset)
import os
...
class SVGService(BaseService):
    ...
    def _initialize_models(self):
        ...
        if "dino" not in self._models:
            from tracerigor.env.svg.dino import DINOScoreCalculator
        ...
        if "dreamsim" not in self._models:
            from tracerigor.env.svg.dreamsim import DreamSimScoreCalculator
