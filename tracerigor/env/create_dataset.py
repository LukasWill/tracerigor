import os
from tracerigor.env import get_environment
import numpy as np
import yaml
import argparse
from datasets import Dataset, load_dataset
from tracerigor.env.utils.env_utils import permanent_seed
def create_dataset_from_yaml(yaml_file_path: str, force_gen=False,seed=42,train_path='./train.parquet',test_path='./test.parquet'):
    ...
    for key, value in yaml_config.items():
        ...
        env_config = get_environment(env_name)["config_cls"](**custom_env_config)
...
if __name__ == "__main__":
    ...
    for i in range(2):
        ...
        env_config_cls = get_environment(env_name)["config_cls"]
